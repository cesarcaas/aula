...
ALTER TABLE ONLY public.tb_product_category
    ADD CONSTRAINT tb_product_category_pkey PRIMARY KEY (product_id, catagory_id);
...
--
-- Name: tb_product_category fk4q60s62yxj0jngxditced545w; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product_category
    ADD CONSTRAINT fk4q60s62yxj0jngxditced545w FOREIGN KEY (catagory_id) REFERENCES public.tb_category(id);
